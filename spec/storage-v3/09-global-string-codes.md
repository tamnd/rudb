...
Q35 by 3.85x; document 13 has the measurement. The reversal is not an argument against stable
codes, whose reasoning above stands on its own. It means this document has never been tested at the
size that decides it, and the tenfold win quoted here must not be cited as though it had been.
