...
9. A requirement is settled by a measurement at the full benchmark size. The 1k through 10m ladder is for development. Document 13 is the measurement of what that distinction cost: at one million rows rudb leads the 43-query suite by 1.11x and at one hundred million it trails by 2.30x, and three decisions in this series were closed on evidence from the wrong end of that curve.
