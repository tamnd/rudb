...
mod tests {
    ...
    /// A spread of real SQL, one line each, covering the statement kinds M0 has to reach and a
    /// good deal of what it does not yet.
    ///
    ...
    /// to a table and walked by this file, accept the language at all. Every one of these is
