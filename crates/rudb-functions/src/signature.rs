...
const TABLE: &[Entry] = &[
    ...
    // The pin declares these over DOUBLE alone, so a string or a boolean is refused rather than
    // read as a number.
    aggregate("product", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("var_samp", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("var_pop", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("stddev_samp", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("stddev_pop", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("sem", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("fsum", Arity::exactly(1), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    ...
    // The pairs, each `(y, x)` in that order.
    aggregate("corr", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("covar_pop", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("covar_samp", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_avgx", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_avgy", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate(
        "regr_count",
        Arity::exactly(2),
        Shape::FixedTo(Fixed::Double, Fixed::UInteger),
        true,
    ),
    aggregate(
        "regr_intercept",
    ...
    aggregate("regr_r2", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_slope", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_sxx", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_sxy", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate("regr_syy", Arity::exactly(2), Shape::FixedTo(Fixed::Double, Fixed::Double), true),
    aggregate(
        "string_agg",
        Arity::between(1, 2),
