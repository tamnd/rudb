...
//! Six pieces:
//!
//! - [`Vector`], a typed run of at most [`VECTOR_SIZE`] values in one of seven physical forms.
...
pub use assemble::{Assembly, concat};
...
pub use vector::{
    ...
    PACKING_PAYS_AT, Packed, TextSource, VECTOR_SIZE, Vector,
};
