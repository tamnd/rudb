...
SELECT CASE WHEN a = 30 THEN 'a value only in the gap' ELSE 'x' END AS s, a AS n FROM range(100) t(a)
SELECT CASE WHEN a = 90 THEN 'a value in the tail' ELSE 'x' END AS s, a AS n FROM range(100) t(a)
